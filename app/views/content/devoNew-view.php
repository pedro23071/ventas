...
<div class="container pb-6 pt-6">
    ...
    <form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/devolucionAjax.php" method="POST" autocomplete="off" enctype="multipart/form-data" >
        ...
        <div class="columns">
            <div class="column">
                <div class="control">
                    <label>Id de la venta <?php echo CAMPO_OBLIGATORIO; ?></label>
                    <input class="input" type="text" name="venta_id" pattern="[0-9]*" title="Ingresa solo números" required>
                </div>
            </div>
            <div class="column">
                <div class="control">
                    <label>Codigo de venta <?php echo CAMPO_OBLIGATORIO; ?></label>
                    <input class="input" type="text" name="venta_codigo" pattern="[A-Za-z]\d[A-Za-z]\d-\d" title="Formato inválido." maxlength="15" required >
                </div>
            </div>
        </div>
        <div class="columns">
